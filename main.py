...
BOT_TOKEN = "8739659081:AAFvmhHW0R12acxQtQzE0CHxVaadJYTU6EE"
FEEDBACK_CHAT_ID = 7861730285   # <--- ID MO DITO
LOG_CHANNEL_ID = 7861730285      # <--- ID MO DITO
OWNER_USERNAME = "@Ger"

# ⚙️ CHECKER SETTINGS
BOT_NAME = "Xcs"         
MAX_THREADS = 10          # 📉 BINAWASAN KO PARA HINDI MAG-CRASH (PWEDE TAASAN HANGGANG 10)
COOLDOWN_TIME = 147      
